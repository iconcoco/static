 ...
 <transition name="fade">
    <div class="store-detaile-container">
        ...
        <template v-if="['BM','EU',].indexOf(pageData.platformCode)>-1">
            ...
            <div class="account-info" v-for="(item,key,index) in storeInfo.nation" :key="index">
                ...
                <div class="account-item">
                    ...
                    <!-- <p v-html="item.accountNo" tipsInfo></p> -->
        ...
        <AdminModel v-model="addNewModel">
            ...
            <p>
                <span class="cares-button-danger pain"  @click="bindCloseModel">取消添加</span>
                <span class="cares-button-primary" @click="bindConfirmModel">确认添加</span>
            </p>
        </AdminModel>
    </div>
 </transition>
...
<script>
    ...
    //2018-11-28  实名认证的组件
    import AuthenticationCompany from './AuthenticationCompany.vue';
