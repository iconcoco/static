        ...
        <div class="complate-account">
            ...
            <div class="complate-account-item clearfix">
                ...
                <div class="fl">
                    ...
                    <label for="per_bank" :class="{active:type=='1'}">
                        个人账号
                        <span>仅支持提现到个人账户，提交后无法修改，请谨慎选择</span>
                    </label>
                    <label for="com_bank" :class="{active:type=='2'}">
                        企业账号
                        <span>仅支持提现到企业对公账户，提交后无法修改，请谨慎选择</span>
                    </label>
...
@import './../../../../css/common/theme.scss';
    ...
    .complate-account .complate-account-item{
        padding-bottom: 60px;
        label{
            &.active{
                span{
