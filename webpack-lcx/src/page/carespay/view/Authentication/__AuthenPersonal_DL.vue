                ...
                <div class="content" :class="{fadeIn:showIdPop}">
                    ...
                    <div class="clearfix idCard">
                        <p class="fl">
                           <span>手持身份证示例</span>
                           <label class="img">
                               <img src="../../../../images/carepay/hold-e.png" alt="身份证证明">
                           </label>
                           <i class="no">常见错误：</i><br/>
                           <i class="no">1、脸部被手或身份证遮挡</i><br/>
                           <i class="no">2、图片模糊，无法识别身份证上信息</i><br/>
                           <i class="no">3、身份证上信息被遮住无法识别</i>
                        </p>
                        <p class="fr">
                           <span></span>
                           <label class="img">
                               <img src="../../../../images/carepay/hold-r.png" alt="身份证反面">
                           </label>
                           <i class="yes">正确规范：</i><br/>
                           <i class="yes">1、图片和身份证清晰</i><br/>
                           <i class="yes">2、脸部无遮拦</i><br/>
                           <i class="yes">3、身份证信息无遮拦，易识别</i>
                        </p>
                    </div>
                </div>
            </el-popover>
